...
export const ABOUT: AboutData = {
  ...
  About: {
    hero: {
      title: "Who are we ?",
      description:
        "He Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet.",
      ctaLink: "#",
    },
    purpose: {
      title: "Our purpose",
